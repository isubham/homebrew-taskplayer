...
pub(crate) const TIMER_PAUSE_REASON_TASK_COMPLETED: &str = "task_completed";
pub(crate) const TIMER_PAUSE_REASON_TASK_DELETED: &str = "task_deleted";
pub(crate) const TIMER_PAUSE_REASON_TASK_SWITCH: &str = "task_switch";
...
pub(crate) const TIMER_PAUSE_TRIGGER_TASK_LIFECYCLE: &str = "task_lifecycle";
